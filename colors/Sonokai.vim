...
call sonokai#highlight('Directory', s:palette.red, s:palette.none)
...
call sonokai#highlight('CustomBlue', s:palette.c_blue, s:palette.none)
call sonokai#highlight('CustomFg', s:palette.c_fg, s:palette.none)
call sonokai#highlight('CustomRed', s:palette.c_red, s:palette.none)
call sonokai#highlight('CustomYellow', s:palette.c_yellow, s:palette.none)
call sonokai#highlight('CustomOrange', s:palette.c_orange, s:palette.none)
call sonokai#highlight('CustomPurple', s:palette.c_purple, s:palette.none)
call sonokai#highlight('CustomGrey', s:palette.c_grey, s:palette.none)
call sonokai#highlight('CustomGreen', s:palette.c_green, s:palette.none)
call sonokai#highlight('CustomBrown', s:palette.c_brown, s:palette.none)
call sonokai#highlight('CustomGreen2', s:palette.c_green2, s:palette.none)
...
highlight! link TSConstBuiltin CustomOrange
highlight! link TSConstMacro OrangeItalic
highlight! link TSConstant OrangeItalic
highlight! link TSConstructor Red
highlight! link TSException CustomRed
highlight! link TSField Orange
highlight! link TSFloat Purple
highlight! link TSFuncBuiltin CustomOrange
highlight! link TSFuncMacro CustomOrange
highlight! link TSFunction Red
highlight! link TSInclude CustomRed
highlight! link TSKeyword CustomRed
highlight! link TSKeywordFunction CustomRed
highlight! link TSKeywordOperator Red
highlight! link TSLabel CustomGreen2
highlight! link TSLiteral CustomGreen2
highlight! link TSMethod Red
highlight! link TSNamespace CustomFg
highlight! link TSNone Fg
highlight! link TSNumber Purple
highlight! link TSOperator Grey
highlight! link TSParameter CustomOrange
highlight! link TSParameterReference CustomOrange
highlight! link TSProperty Orange
highlight! link TSPunctBracket Grey
highlight! link TSPunctDelimiter Grey
highlight! link TSPunctSpecial CustomBlue
highlight! link TSRepeat Red
highlight! link TSString Green
highlight! link TSStringEscape CustomGreen2
highlight! link TSStringRegex CustomGreen2
highlight! link TSStructure OrangeItalic
highlight! link TSSymbol CustomFg
highlight! link TSTag CustomRed
highlight! link TSTagDelimiter CustomRed
highlight! link TSTagAttribute Red
highlight! link TSText CustomGreen2
highlight! link TSStrike Grey
highlight! link TSMath CustomBlue
...
" }}}
" thiagoalessioerainbow_levels.vim {{{
...
" }}}
" Extended File Types: {{{
" zaWhitelist: {{{ File type optimizations that will always be loaded.
" diff {{{
...
highlight! link CocExplorerFileDirectory CustomRed
